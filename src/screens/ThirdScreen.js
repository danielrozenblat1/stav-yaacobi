...
<div className={styles.title}>וזה קורה ככה</div>
  <div className={styles.center}>
      ...
      <ProcessStep
        number="3"
        title="יום האירוע"
        description="ביום הגדול, אהיה איתך מתחילת היום ועד לאירוע עצמו. אטפל באיפור, שיער, והתארגנות כללית, כולל ליווי בצילומים, כדי להבטיח שתרגישי ותיראי הכי טוב שאפשר."
      />
    </div>
